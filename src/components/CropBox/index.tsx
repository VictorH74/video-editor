  ...
  return (
    <div ref={containerRef} className="absolute inset-0 select-none">
      <DraggableResizableBox
        ...
        masks={
          <>
            <div ref={maskWestRef} className="absolute pointer-events-none left-0 bg-[#00000094]" />
            <div
              ref={maskNorthRef}
              className="absolute pointer-events-none top-0 inset-x-0 bg-[#00000094]"
            />
            <div ref={maskEastRef} className="absolute pointer-events-none right-0 bg-[#00000094]" />
            <div
              ref={maskSouthRef}
