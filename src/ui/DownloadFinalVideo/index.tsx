    ...
    <div className="h-screen grid place-items-center">
      <main className="flex flex-col gap-6 text-center">
        ...
        <a
          ...
          className="bg-gradient-to-r from-red-200 from-10% via-blue-500 via-50% to-cyan-400 to-100% uppercase font-medium p-4 rounded-lg text-white hover:scale-105 duration-200"
        >
